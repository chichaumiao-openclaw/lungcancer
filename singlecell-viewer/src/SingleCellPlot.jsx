...
export default function SingleCellPlot({ data, selectedSubtype, subtypeLabel }) {
  const canvasRef = useRef(null);

  const filtered = useMemo(
    () => data.filter((d) => !selectedSubtype || d.subtype === selectedSubtype),
  ...
  return (
    <div className="panel plot-panel">
      ...
      <p className="hint">{subtypeLabel} subset with simulated subtype grouping and dynamic color modes.</p>
